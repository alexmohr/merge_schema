...
--
-- Host: win7-3313    Database: vega8_all
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=237 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='state indication for commchannel items';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1269 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=17614 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Defines which signal tags are exported in a export.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=546 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Connects the hardware group with a driver. \nOne driver can have multiple groups. \nBut a group can only have 1 driver			';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=1220 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Lists additional properties (generic attributes) of hardware groups.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2508 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=6160 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='This table may be used to connect one io port to another.\nThis is used to connect the io port of a probe to the io port of a hardware device.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10659 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=914 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21695 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='This table exists to freely group signals and tags.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `cat_localization` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=349 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='This table will later contain string for localizing stuff. ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=27630 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Ersetzt KatalogTabellen ohne weitere Abhaengigkeiten. Also : Keine Beziehungen wie Land und Stadt. aber Einfache Auflistungen wie : Farben, Zustaende, Gewinde,....\nWird ein Eintrag pro Entity eingefügt, muss die gesamte Zeile eingefügt werden, wie in gewöhnlichen Tabellen.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2500 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=367 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Global table which holds the state of various entities.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1972 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT=' ';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=22581 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='This trigger will validate the connection to port id column to verify that if object A references object B, then B must reference A as well.';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2996 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Tables may be grouped by device nodes for efficient writing to devices.\nIt enables us to collect all signal changes for one devices and bulk write them to the hardware / usercontrol / script. \n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=30447 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=2609 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='a tag group contains 0..n signals';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
-- Dump completed on 2017-02-21 11:55:42
